...
class User extends Kareem3dUser {
    ...
    public function controlElement( Element $element )
    {
        ...
        {
            DB::table('fr_user_element')->insert(array(
                'user_id' => $this->id,
    ...
    {
        return $this->getControlPanelPivotQuery( $controlPanel )->where('fr_user_control_panel.accepted', true)->count() > 0;
    }
    ...
    {
        return $this->controlPanels()->where('fr_user_control_panel.control_panel_id', $controlPanel->id);
    }
    ...
    {
        return $this->controlPanels()->where('fr_user_control_panel.control_panel_id', $id)->first();
    }
    ...
    {
        return $this->belongsToMany( ControlPanel::getClass(), 'fr_user_control_panel' )->withPivot('accepted');
    }
    ...
    {
        return DB::table('fr_user_element')->where('user_id', $this->id);
    }
}